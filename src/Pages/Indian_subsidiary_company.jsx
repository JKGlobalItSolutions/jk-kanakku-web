    ...
    <>
        ...
        <div className="container py-5">
          <div className="row align-items-center">
            ...
            <div className="col-lg-7 text-white mb-4 mb-lg-0">
              ...
              <p>
                &#9654; Enter the Thriving Indian Market - Register Your Subsidiary with{" "}
                <span style={{ color: "#ffd08d", fontWeight: 600 }}>JK KANNAKU</span>
              </p>
              
                <p>&#9654; Obtain 2 DSCs with 2 years validity</p>
                <p>&#9654; Get 2 secure Director Identification Number (DIN)</p>
                <p>&#9654; Get unique name approval for your subsidiary company</p>
                <p>&#9654; Acquire PAN and TAN for the company</p>
                <p>&#9654; Open a current account with ICICI Bank</p>
                <p>&#9654; Receive the official Company Incorporation Certificate</p>
      ...
      <div className="container-fluid my-5">
        <div className="row align-items-start">
          ...
          {/* Right Image */}
          <div className="col-lg-5">
            <img src={img3} alt="Procedure" className="img-fluid rounded" />
          </div>
        </div>
      </div>
